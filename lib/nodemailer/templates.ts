...
<style type="text/css">
  body { margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; background-color: #050505; color: #e5e7eb; }
  a { text-decoration: none; }
  .email-container { max-width: 600px; margin: auto; background-color: #141414; border-radius: 8px; border: 1px solid #30333A; }
  .header { padding: 40px; text-align: center; }
  .header img { max-width: 150px; height: auto; }
  .content { padding: 40px; }
  .title { font-size: 24px; font-weight: 600; color: #FDD458; margin-bottom: 20px; line-height: 1.3; }
  .intro { font-size: 16px; line-height: 1.6; color: #ffffff; margin-bottom: 25px; }
  .features { font-size: 16px; line-height: 1.6; color: #d1d5db; margin-bottom: 25px; padding-left: 20px; }
  .features li { margin-bottom: 12px; }
  .cta-button { display: inline-block; background: linear-gradient(135deg, #FDD458 0%, #E8BA40 100%); color: #000; font-weight: 500; padding: 16px 32px; border-radius: 8px; margin-bottom: 25px; }
  .footer { font-size: 14px; color: #9ca3af; text-align: center; padding: 20px; }
    ...
    <tr>
      <td>
        <table class="email-container" role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
          ...
          <tr>
            <td class="header">
              <img src="/public/icons/Watchlist.svg" alt="Watchlist Logo" width="150" style="max-width: 100%; height: auto;">
            </td>
          </tr>
        ...
        <!-- Dashboard Preview Image -->
            <tr>
                <td align="center" class="dashboard-preview" style="padding: 40px 40px 0px 40px;">
                    <img src="/public/email/market-homepage.png" alt="Watchlist Dashboard Preview" width="100%" style="max-width: 520px; width: 100%; height: auto; border-radius: 12px; border: 1px solid #30333A;">
                </td>
            </tr>
          ...
          <tr>
            <td class="content">
              ...
              <ul class="features">
                ...
                <li>Explore your dashboard for trends and market updates</li>
              </ul>

              <a href="https://github.com/dr3wvu/watchlist" class="cta-button">Go to Dashboard</a>
            </td>
          </tr>
          ...
          <tr>
            <td class="footer">
              Watchlist HQ © 2026<br>
              <a href="#" style="color:#9ca3af;">Unsubscribe</a> | 
              <a href="https://github.com/dr3wvu/watchlist style="color:#9ca3af;">Visit Watchlist</a><br>
            </td>
          </tr>
        </table>
      </td>
                        ...
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    You're receiving this because you subscribed to Watchlist news updates.
                                </p>
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    <a href="#" style="color: #CCDADC !important; text-decoration: underline;">Unsubscribe</a> | 
                                    <a href="https://Watchlist.app" style="color: #CCDADC !important; text-decoration: underline;">Visit Watchlist</a>
                                </p>
        ...
        <tr>
            <td align="center" class="mobile-outer-padding" style="padding: 40px 20px;">
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" class="email-container" style="max-width: 600px; background-color: #141414; border-radius: 8px; border: 1px solid #30333A;">
                    ...
                    <tr>
                        <td align="left" class="mobile-header-padding" style="padding: 40px 40px 20px 40px;">
                            <img src="https://ik.imagekit.io/a6fkjou7d/logo.png?updatedAt=1756378431634" alt="Watchlist Logo" width="150" style="max-width: 100%; height: auto;">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="mobile-padding" style="padding: 40px 40px 40px 40px;">
                            ...
                            <p class="mobile-text dark-text-secondary" style="margin: 0 0 30px 0; font-size: 16px; line-height: 1.6; color: #CCDADC;">
                                We noticed you haven't visited Watchlist in a while. The markets have been moving, and there might be some opportunities you don't want to miss!
                            </p>
                            ...
                            <div style="text-align: center; margin: 40px 0 0 0;">
                                ...
                                <p style="margin: 0 0 10px 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    ...
                                    <a href="{{dashboardUrl}}" style="color: #CCDADC !important; text-decoration: underline;">Visit Watchlist</a>
                                </p>
                                <p style="margin: 0; font-size: 14px; line-height: 1.5; color: #CCDADC !important;">
                                    © 2025 Watchlist
                                </p>
